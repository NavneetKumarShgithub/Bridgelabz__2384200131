...
{
    // Step 1: Create a custom exception called InvalidAgeException
    ...
    class Program
    {
        // Step 2: Write a method ValidateAge(int age) that throws InvalidAgeException if age is below 18
        ...
        static void Main()
        {
            ...
            {
                // Step 5: If an exception occurs, display "Age must be 18 or above"
